...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(INVALID_DEFAULT_FUNCTIONAL_PARAMETER_FOR_INLINE, "Invalid ''{0}'' default value for inline parameter. Supported only lambda, anonymous functions, function and property references", ELEMENT_TEXT, SHORT_NAMES_IN_TYPES);
        //Inline non locals
