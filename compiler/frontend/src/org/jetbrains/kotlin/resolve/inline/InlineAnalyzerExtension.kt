    ...
    private fun checkDefaults(
        ...
        for (parameter in functionDescriptor.valueParameters) {
            if (parameter.hasDefaultValue()) {
                ...
                //For other default functional parameters report error for Kotlin version < 1.2 (non LanguageFeature.InlineDefaultFunctionalParameters)
                // and check default value
